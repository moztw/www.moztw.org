...
#
# Project Page: https://moztw.org/tools/mozlcdb/
...
sub printCurrent { # {{{ current document translation for editing
	...
	print F "; Get MozLCDB from https://moztw.org/tools/mozlcdb/\n";
...
sub main { # {{{ main entry
	...
	print STDERR "Project page and manual: https://moztw.org/tools/mozlcdb/\n";
...
#		exit(-1);
#	}
	my $s = "<!-- Generated by MozLCDB, https://moztw.org/tools/mozlcdb -->\n";
	my @hdr = @{$refHdrs};
	$s .= join("", @hdr);
