      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
          ...
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top"><div align="center"><span class="gensmall"><strong>{L_STYLES_TITLE}</strong></span></div></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
        ...
        <tr>
          ...
          <td width="98%" bgcolor="#EAF1FC"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td><div align="justify"><span class="gensmall">{L_STYLES_TEXT}</span></div></td>
            </tr>
          </table></td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
  ...
  <tr valign="bottom">
    <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
      <tr>
        ...
        <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="top"><span class="gensmall"><strong>{L_STYLES_TITLE}</strong></span></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
    ...
    <tr>
      <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
      <td width="98%" bgcolor="#FFFFFF"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
          <td>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
	<tr valign="bottom">
		<th height="25" class="stil06"><table width="100%" height="16"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><div align="center"><span class="gensmall"><strong>{L_STYLE}</strong></span></div></td>
  </tr>
</table>
</th>
		<th height="25" class="stil06"><table width="100%" height="16"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="top"><div align="center"><span class="gensmall"><strong>{L_TEMPLATE}</strong></span></div></td>
          </tr>
        </table></th>
		<th height="25" class="stil06"><table width="100%" height="16"  border="0" cellpadding="0" cellspacing="0">
          <tr>
		...
		<th height="25" colspan="2" class="stil06"><table width="100%" height="16"  border="0" cellpadding="0" cellspacing="0">
          <tr>
	...
	<!-- BEGIN styles -->
	<tr>
		<td bgcolor="#E1ECFB"><div align="center"><span class="gensmall">{styles.STYLE_NAME}</span></div></td>
		<td bgcolor="#EAF1FC"><div align="center"><span class="gensmall">{styles.TEMPLATE_NAME}</span></div></td>
		<td bgcolor="#E1ECFB"><div align="center"><span class="gensmall"><a href="{styles.U_STYLES_EDIT}">{L_EDIT}</a></span></div></td>
		<td bgcolor="#EAF1FC"><div align="center"><span class="gensmall"><a href="{styles.U_STYLES_DELETE}">{L_DELETE}</a></span></div></td>
	</tr>
	<!-- END styles -->
</table>
</form>		  </td>
