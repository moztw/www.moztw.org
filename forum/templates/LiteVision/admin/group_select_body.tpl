      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
          ...
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top"><div align="center"><span class="gensmall"><strong>{L_GROUP_TITLE}</strong></span></div></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
        ...
        <tr>
          ...
          <td width="98%" bgcolor="#EAF1FC"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td><div align="justify"><span class="gensmall">{L_GROUP_EXPLAIN}</span></div></td>
            </tr>
          </table></td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
        <tr valign="bottom">
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                <td width="5%" valign="bottom"><img src="../templates/LiteVision/images/05.gif" width="49" height="21"></td>
                <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top"><div align="left"><span class="gensmall"><strong>&nbsp;{L_GROUP_TITLE}</strong></span></div></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
        ...
        <tr>
          ...
          <td width="98%"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <th height="26" align="center" valign="bottom" class="stil06"><table width="100%" height="16"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top"><div align="center"><span class="gensmall"><strong>{L_GROUP_SELECT}</strong></span></div></td>
                </tr>
              </table></th>
            </tr>
            <!-- BEGIN select_box -->
            <tr>
              <td height="25" align="center" bgcolor="#E1ECFB">{S_GROUP_SELECT}&nbsp;&nbsp;
                  <input type="submit" name="edit" value="{L_LOOK_UP}" class="form2" />
            &nbsp;</td>
            </tr>
            <!-- END select_box -->
            <tr>
              <td height="20" align="center" bgcolor="#EAF1FC">{S_HIDDEN_FIELDS}
                  <input type="submit" class="form2" name="new" value="{L_CREATE_NEW_GROUP}" /></td>
            </tr>
          </table></td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
