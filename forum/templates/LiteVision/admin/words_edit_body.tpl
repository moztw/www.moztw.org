        ...
        <tr valign="bottom">
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top"><div align="left"><span class="gensmall"><strong>&nbsp;{L_WORD_CENSOR}</strong></span></div></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
	<tr>
		<td width="50%" bgcolor="#E1ECFB"><div align="center"><span class="gensmall">{L_WORD}</span></div></td>
		<td width="50%" bgcolor="#EAF1FC"><div align="center"><span class="gensmall"><input class="form2" type="text" name="word" value="{WORD}" /></span></div></td>
	</tr>
	<tr>
		<td width="50%" bgcolor="#E1ECFB"><div align="center"><span class="gensmall">{L_REPLACEMENT}</span></div></td>
		<td width="50%" bgcolor="#EAF1FC"><div align="center"><span class="gensmall"><input class="form2" type="text" name="replacement" value="{REPLACEMENT}" /></span></div></td>
	</tr>
	<tr>
		<td height="25" colspan="2" align="center" bgcolor="#E1ECFB">{S_HIDDEN_FIELDS}
		  <input type="submit" name="save" value="{L_SUBMIT}" class="form2" /></td>
	</tr>
</table>		  </td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
