...
<table width="98%"  border="0" cellspacing="0" cellpadding="0" align="center">
  <td>
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-maro-jos">
        <tr valign="bottom">
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="middle"><div align="left">
                    <table width="90%" height="20"  border="0" align="left" cellpadding="0" cellspacing="0">
                      <tr>
                        <td valign="top">&nbsp;&nbsp;<span class="genmed"><strong>{MESSAGE_TITLE}</strong></span></td>
                      </tr>
                    </table>
                </div></td>
              </tr>
        ...
        <tr>
          ...
          <td width="98%" height="28" valign="middle"><table width="100%" cellspacing="0" cellpadding="1" border="0">
              <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
