...
<table width="100%" border="0" cellspacing="0" cellpadding="10">
	<tr>
		<td><table width="100%" border="0" cellspacing="2" cellpadding="2" class="border-bleu">
			<tr>
				<td class="stil06" height="25"><div align="center"><span class="genmed"><strong>{L_EMOTICONS}</strong></span></div></td>
			</tr>
			<tr>
