...
$HTTP_POST_VARS['show_results'] : ( (isset($HTTP_GET_VARS['show_results'])) ?
$HTTP_GET_VARS['show_results'] : 'posts');
...
else if ( isset($HTTP_GET_VARS['search_terms']) )
{
   $search_terms = ( $HTTP_GET_VARS['search_terms'] == 'all' ) ? 1 : 0;
} 
else
{
	$search_terms = 0;
